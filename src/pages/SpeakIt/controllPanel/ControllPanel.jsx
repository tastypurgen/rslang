...
const ControllPanel = props => {
    ...
    return (
        <div className="ControllPanel">
            <button onClick={() => {
                startNewGame();
            }} className="ControllPanel__restart ControllPanel__button">restart</button>
            <button onClick={() => {
            ...
            }} className="ControllPanel__speak ControllPanel__button">{!speechState ? 'to speak'
                : 'stop speaking'}</button>
            <button
                onClick={() => {
                    props.toShowResults();
                }}
                className="ControllPanel__finish ControllPanel__button">Finish</button>
        </div>
    )
}
